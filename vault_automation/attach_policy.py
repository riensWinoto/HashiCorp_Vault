...
get_member_entityID.append(f"{get_entityID}") #add new member entity id to current member entity id
...
if req_add_member.status_code == 204: 
    print(f"Add member to group status code: {req_add_member.status_code}")
else:
    sys.exit(1)